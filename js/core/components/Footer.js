...
export function Footer() {
    const html = `
        <footer class="bg-gradient-to-br from-[#0f0f0f] via-[#1a1a1a] to-[#0f0f0f] text-white pt-16 pb-8 border-t-2 border-[#AA8C3C]/30">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-black/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10 shadow-2xl">
                        ...
                        <div class="flex items-center gap-3 mb-6">
                            <div class="w-14 h-14 bg-gradient-to-br from-[#AA8C3C] to-[#8B7530] rounded-lg flex items-center justify-center transform rotate-45 shadow-lg">
                        ...
                        <div class="space-y-5 text-gray-100">
                            <div class="flex items-start gap-3">
                                <div class="mt-1 w-10 h-10 rounded-full bg-gradient-to-br from-[#AA8C3C] to-[#8B7530] flex items-center justify-center flex-shrink-0 shadow-md">
                                    <i data-lucide="map-pin" class="w-5 h-5 text-white"></i>
                                </div>
                                <div class="text-sm">
                                    <span class="text-[#AA8C3C] font-bold block mb-1">Trụ sở chính:</span>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="text-sm">
                                    <span class="text-[#AA8C3C] font-bold block mb-1">Chi nhánh HCM:</span>
                                    <span class="text-gray-200">Số 466 Hai Bà Trưng, phường Tân Định, Thành phố Hồ Chí Minh</span>
                                </div>
                            </div>

                            <div class="flex items-start gap-3">
                                <div class="w-10 h-10 rounded-full bg-gradient-to-br from-[#5EEAD4] to-[#14B8A6] flex items-center justify-center flex-shrink-0 shadow-md">
                                    <i data-lucide="phone" class="w-5 h-5 text-white"></i>
                                </div>
                                <div class="text-sm">
                                    <span class="text-[#5EEAD4] font-bold">Hotline CSKH:</span>
                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-10 h-10 rounded-full bg-gradient-to-br from-[#AA8C3C] to-[#8B7530] flex items-center justify-center flex-shrink-0 shadow-md">
                                    <i data-lucide="mail" class="w-5 h-5 text-white"></i>
                                </div>
                                <div class="text-sm space-y-1">
                                    <div>
                                        <span class="text-[#AA8C3C] font-bold">Đấu giá biển số:</span>
                                        <span class="text-gray-200 ml-1">dgbs@vpa.com.vn</span>
                                    </div>
                                    <div>
                                        <span class="text-[#AA8C3C] font-bold">Đấu giá tài sản:</span>
                                        <span class="text-gray-200 ml-1">dgts@vpa.com.vn</span>
                                    </div>
                                    <div>
                                        <span class="text-[#AA8C3C] font-bold">Liên hệ hợp tác:</span>
                    ...
                    <div class="bg-black/30 backdrop-blur-sm rounded-2xl p-8 border border-white/10 shadow-2xl flex flex-col">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="flex gap-4">
                                <a href="#" class="bg-[#1877F2] hover:bg-[#0e5fc7] text-white p-3 rounded-lg transition-all duration-300 transform hover:scale-110 shadow-lg">
                                    <i data-lucide="facebook" class="w-7 h-7"></i>
                                </a>
                                <a href="#" class="bg-[#0084FF] hover:bg-[#0066CC] text-white px-4 py-3 rounded-lg transition-all duration-300 transform hover:scale-110 font-bold text-sm flex items-center justify-center shadow-lg">
                                    Zalo
                                </a>
                            </div>
                        </div>
                            ...
                            <ul class="space-y-3">
                                <li>
                                    <a href="#" class="text-gray-200 hover:text-white transition-colors flex items-center gap-2 group">
                                        <i data-lucide="chevron-right" class="w-4 h-4 text-[#AA8C3C] group-hover:translate-x-1 transition-transform"></i>
