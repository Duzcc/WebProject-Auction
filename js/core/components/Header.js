            ...
            <div class="bg-gradient-to-r from-[#1a1a1a] via-[#2a2a2a] to-[#1a1a1a] text-white text-xs py-2 px-4 flex justify-between items-center border-b border-[#AA8C3C]/20">
                <div class="overflow-hidden w-full max-w-4xl whitespace-nowrap">
                    <div class="inline-block animate-marquee pl-4" id="marquee-ticker">
                        <span class="inline-block pr-8">Biển số nổi bật ngày <span class="ticker-date"></span>: 33.33, 68AA-888.88, 49AA-888.88, 47AD-444.44, 74H-024.68, 22H-024.68, 29E-444.40, 29E-433.33, 29E-444.47, 29E-411.11.</span>
                        <span class="inline-block pr-8">Biển số nổi bật ngày <span class="ticker-date"></span>: 33.33, 68AA-888.88, 49AA-888.88, 47AD-444.44, 74H-024.68, 22H-024.68, 29E-444.40, 29E-433.33, 29E-444.47, 29E-411.11.</span>
                    </div>
                </div>
