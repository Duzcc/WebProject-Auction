...
export function initBackToTop(showAfter = 300) {
    ...
    backToTopButton.className = 'back-to-top fixed bottom-6 right-6 bg-gradient-to-r from-[#AA8C3C] to-[#AA8C3C] text-white p-4 rounded-full shadow-2xl hover:shadow-3xl hover:scale-110 transition-all duration-300 z-50 opacity-0 pointer-events-none';
