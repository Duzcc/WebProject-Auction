...
export function NotificationArchivePage({ notifData = [] }) {
    const container = createElement('div', { className: 'bg-white py-10 min-h-[70vh]' });
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div class="relative md:col-span-2">
                <input 
                    ...
                    class="w-full border border-gray-300 rounded-lg py-2.5 pl-10 pr-4 text-sm focus:outline-none focus:border-[#be1e2d] focus:ring-1 focus:ring-[#be1e2d] shadow-sm"
                />
            ...
            <div class="relative">
                <input 
                    ...
                    class="w-full border border-gray-300 rounded-lg py-2.5 px-4 text-sm text-gray-500 focus:outline-none focus:border-[#be1e2d] appearance-none cursor-pointer shadow-sm"
                />
    ...
    const paginationHtml = `
        <div class="flex justify-end items-center mt-6">
            <div class="flex items-center gap-2 mr-4 text-sm">
                <span class="text-[#be1e2d] font-bold">Xem</span>
...
function createNotificationRow(item) {
    ...
    const rowHtml = `
        <div class="flex border-b border-gray-100 py-3 items-center text-sm transition-colors hover:bg-red-50/50">
            ...
            <div class="w-1/6 px-4 text-center">
                <a href="#" class="text-[#be1e2d] font-bold cursor-pointer hover:underline whitespace-nowrap">
                    Tải xuống
                </a>
            </div>
        </div>
