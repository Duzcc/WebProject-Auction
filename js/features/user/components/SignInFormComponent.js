...
import { validateEmail, validatePassword, showError, clearError, validateForm } from '../utils/validation.js';
import { login, authenticate } from '../utils/auth.js';

/**
 * SignInForm Component
 * Reusable signin form component
 */
export function createSignInForm(onLoginSuccess) {
...
async function handleSignInSubmit(e, form, submitBtn, onLoginSuccess) {
    ...
    try {
        ...
        // Force reload if on cart/payment pages
