...
<figure class="my-4">
<img src="https://s3-hfx03.fptcloud.com/vpa-web/photos/3a8a0074-00c7-4740-b488-21b09c29a3ff.png" alt="Phiên đấu giá biển số"
  style="display:block;margin:0 auto;width:100%;max-width:400px;height:400px;border-radius:6px;" />  
  <figcaption class="text-sm text-gray-500 mt-2 text-center">Ảnh: Khung diễn ra phiên đấu giá (Nguồn: VPA)</figcaption>
</figure>

<p>Thông tin thêm: người trúng đấu giá sẽ thực hiện các nghĩa vụ tài chính trong thời hạn quy định và hoàn tất thủ tục chuyển quyền sử dụng biển số. Sự kiện này tiếp tục khẳng định xu hướng đấu giá biển số xe đang trở thành một ngành nghề hấp dẫn với nguồn thu lớn cho ngân sách.</p>` },
