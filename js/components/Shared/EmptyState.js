...
export function EmptyState({
    ...
    if (action) {
        ...
        button.className = 'bg-gradient-to-r from-[#be1e2d] to-[#8b1818] text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg hover:scale-105 transition-all duration-200';
